    ...
    <ThemeProvider theme={theme}>
      <Grid container component="main" sx={{ height: '100vh' }}>
        ...
        <Grid
          ...
          sx={{
            backgroundImage:
              'url(https://dcfray.com/wp-content/uploads/2018/10/tailgating-espn.com_.png)',
              ...
              <Grid container>
                <Grid item xs>
                  <Link href="/login" variant="body2">
                    Not a host? Try logging in as a user to sign up for
                    Tailgates!
                  </Link>
                </Grid>
                <Grid item>
                  <Link href="/registerhost" variant="body2">
